...
public class AdminRatingController {
	...
	public String adminList(@RequestParam(value="searchn", defaultValue="3", required=false) int searchn, @RequestParam(value="search", defaultValue="", required=false) String search, @RequestParam(name="p", defaultValue = "1") int page, Model m) {
		int count = aservice.count(searchn,search);
		if(count > 0) {
		...
		List<MemberDto> alist = aservice.adminList(searchn, search, startRow);
