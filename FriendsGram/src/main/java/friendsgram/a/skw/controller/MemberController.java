...
public class MemberController {
	...
	@PostMapping("/login")
	public String login(@ModelAttribute("command") @Validated MemberDto dto, BindingResult error, Model m) {
	...
	public String delete(@RequestParam(value="formpw",required = false) String formpw, @ModelAttribute("user") MemberDto dto, SessionStatus status) {
