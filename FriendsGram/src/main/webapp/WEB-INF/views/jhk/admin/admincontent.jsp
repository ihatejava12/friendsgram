        ...
        <div class="container-main">
            ...
            <main>
                <form action="/updaterating">
                    <table>
                        <tr><td>아이디</td><td>${aclist.id}<input type="hidden" value="${aclist.id}" name="id" ></td></tr>
                        <tr><td>이메일</td><td>${aclist.email}</td></tr>
                        <tr><td>전화번호</td><td>${aclist.phone}</td></tr>
                        <tr><td>제재여부</td><td>
                        ...
                        <tr><td colspan="2" align="right">
                            <a href="/adminpage/adminlist" class="button-link">목록으로 이동</a>
                            <input type="submit" name="update" id="update" value="확정">
                        </td></tr>
                    </table>
                </form>
            </main>
