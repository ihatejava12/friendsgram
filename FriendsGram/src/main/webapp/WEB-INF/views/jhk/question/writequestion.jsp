...
<body>
	...
	<form method="post" action="/insertanswer">
		<input type="hidden" value="${q_no}" name="q_no">
		<table border="1">
			<tr>
				<td>제목</td>
			...
			<tr>
				...
				<td><input type="hidden" name="id" value="${user.id}" readonly>${user.id}</td>
			</tr>
			<tr>
				<td>내용</td>
				<td>
	        	<textarea name="content" id="editorTxt" rows="20" cols="70" placeholder="내용을 입력해주세요"></textarea>
				</td>
			</tr>
			<tr>
				<td colspan="2" align="center">
					<input type="submit" id="save" value="답변하기"> 
					<a href="/adminpage/questionlist">돌아가기</a> 
				</td>
			</tr>
		</table>
	</form>
