...
/* 버튼 공통 스타일 */
button, input[type="button"], a.button-link {
    ...
    font-size: 16px; /* 버튼 텍스트 크기 통일 */
    text-align: center;
    display: inline-block;
}

button:hover, input[type="button"]:hover, a.button-link:hover {
...
button#delete:hover, #delete:hover {
...
<body>
    <div class="container">
        ...
        <div class="container-main">
            ...
            <main>
                <table>
                    <tr><td>아이디</td><td>${memlist.id}</td></tr>
                    <tr><td>이름</td><td>${memlist.name}</td></tr>
                    <tr><td>이메일</td><td>${memlist.email}</td></tr>
                    <tr><td>전화번호</td><td>${memlist.phone}</td></tr>
                    <tr><td>제재횟수</td><td>
                    ...
                    <tr><td colspan="2" align="right">
                        <a href="/adminpage/memberlist" class="button-link">목록으로 이동</a>
