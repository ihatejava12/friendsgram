...
<body>
	...
	<hr>
	<table border="1">
	<tr><td>제목</td><td>${blist4.title}</td>
	<tr><td>작성자</td><td>${blist4.id}</td>
	<tr><td>내용</td><td>${blist4.content}</td>
	<tr><td>등록일</td><td><fmt:formatDate value="${blist4.date}" dateStyle="short"/>
	<tr><td colspan="2" align="right">
	<a href="/adminpage/board04">목록으로 이동</a>
	<span id="delete">
	...
	<script>
		$(function(){
			$("#delete").on("click", function(){
				let no = ${blist4.b_no04};
				$.ajax({url:"/delete4/"+no,
					method:"delete"
				}).done(function(){
					location.href='/adminpage/board04';
				})
			})
		})
	</script>
