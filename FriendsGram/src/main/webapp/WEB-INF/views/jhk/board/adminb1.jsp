			...
			<main>
				<div class="filter-bar">
					<form action="board01">
						...
						</select> <input name="search" type="text" placeholder="검색 내용을 입력하세요"
							size=30 /> <input type="submit" value="검색" />
					</form>
				</div>
					...
					<tbody>
						<c:forEach var="list01dto" items="${list01}">
							<tr>
								...
								<td align="center"><a
									href="/adminpage/content1/${list01dto.b_no01}">${list01dto.title}</a></td>
								<td align="center">${list01dto.id}</td>
								<td align="center"><fmt:formatDate
										value="${list01dto.date}" dateStyle="short" /></td>
								<td align="center"><input type="checkbox" name="no"
									value="${list01dto.b_no01}" /></td>
							</tr>
						</c:forEach>
					</tbody>
				</table>
