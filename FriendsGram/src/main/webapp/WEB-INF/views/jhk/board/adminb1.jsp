		...
		<form action="board01">
			...
			<table>
				...
				<tr>
				   ...
				   <tbody>
				<c:forEach var="list01dto" items="${list01}">
					<tr>
						<td>${list01dto.b_no01}</td>
						<td align="center"><a href="/adminpage/content1/${list01dto.b_no01}">${list01dto.title}</a></td>
						<td align="center">${list01dto.id}</td>
						<td align="center"><fmt:formatDate value="${list01dto.date}" dateStyle="short"/></td>
						<td align="center"><input type="checkbox" name="no" value="${list01dto.b_no01}"/></td>
					</tr>
				</c:forEach>
				 </tbody>
			</table>
