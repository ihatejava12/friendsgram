	...
	<div class="container">
        ...
        <div class="container-main">
			...
			<tr>
				<td>내용</td>
				<td>
	        	<textarea name="content" id="editorTxt" rows="20" cols="70" placeholder="내용을 입력해주세요" readonly>${dto.content}</textarea>
				</td>
			</tr>
			<tr>
				<td>첨부파일</td>
			...
			<tr>
				<td colspan="2" align="center">
					<a href="/adminpage/advertisinglist">돌아가기</a>
					<c:if test="${dto.request == false}">
						<a href="/advertising/write/${dto.a_no}">답변하기</a>
					</c:if>
				</td>
			</tr>			
